  ...
  <div class="p-5 text-center bg-body-tertiary">
	<div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">Welcome to WackoPicko</h1>
        <p class="fs-4 text-center">On WackoPicko, you can share all your crazy pics with your friends. <br />
	    But that's not all, you can also buy the rights to the high quality <br />
	    version of someone's pictures. WackoPicko is fun for the whole family.</p>
	    ...
	    <h3>New Here?</h3>
		  ...
		  <p>
		    <h4><a href="./users/sample.php">Check out a sample user!</a></h4>
		  </p>
		  <p>
